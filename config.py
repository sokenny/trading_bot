...
TAKE_PROFIT = 1.5 # Distancia que tiene que recorrer el precio a favor nuestro para completar la posicion y tomar las ganancias
POSITION_STRUCTURE = [{'weight': .15}, {'weight': .15}, {'weight': .25}, {'weight': .35}] # Posiciones a abrir por cada señal de trade con sus respectivos "weights" que representan un porcentaje del importe a tradear
